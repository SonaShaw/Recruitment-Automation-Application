	...
	<div class = "col-sm-12">
		<div align = "right">
			<span style = "float:left">
				<a type="submit" name = "home" href = "../hod_home.php" style="width: 100px; height: 45px;"><font face = "Times New Roman" size="4" color = "01a0c7"><b>Home</b></font></a>
			</span>
			...
			<div class = "">
					...
					<table>
						...
						<tr>
							...
							<div class="">
								<td>	
									<INPUT id ="accountingmarks" TYPE = "number" NAME = "accounting_marks" style="width: 50px;" value = "<?php echo $m['accounting_marks']; ?>"
						...
						<tr>
							...
							<div class="">
								<td>	
									<INPUT id ="excelmarks" TYPE = "number" NAME = "excel_marks" style="width: 50px;" value = "<?php echo $m['excel_marks']; ?>"
									oninput ="evaluateResult('passed','considered','failed','accountingmarks','excelmarks','englishmarks','aptitudemarks','typingmarks')"
						...
						<tr>
							...
							<div class="">
								<td>	
									<INPUT id ="englishmarks" TYPE = "number" NAME = "english_marks" style="width: 50px;" value = "<?php echo $m['english_marks']; ?>" 
									oninput ="evaluateResult('passed','considered','failed','accountingmarks','excelmarks','englishmarks','aptitudemarks','typingmarks')" 
									AUTOFOCUS readonly required>
						...
						<tr>
							...
							<div class="">
								<td>	
									<INPUT id ="aptitudemarks" TYPE = "number" NAME = "aptitude_marks" style="width: 50px;" value = "<?php echo $m['aptitude_marks']; ?>" 
									oninput ="evaluateResult('passed','considered','failed','accountingmarks','excelmarks','englishmarks','aptitudemarks','typingmarks')"
									AUTOFOCUS readonly required>
						...
						<tr>
							...
							<div class="">
								<td>	
									<INPUT id ="typingmarks" TYPE = "number" NAME = "typing_marks" style="width: 50px;" value = "<?php echo $m['typing_marks'] ?>" readonly
									oninput ="evaluateResult('passed','considered','failed','accountingmarks','excelmarks','englishmarks','aptitudemarks','typingmarks')"
									AUTOFOCUS required>&nbsp &nbsp &nbsp
									<label><font face = "Times New Roman" size = "4"><b>Accuracy  </b></font></label>&nbsp &nbsp
									<INPUT id ="accuracy" TYPE = "number" NAME = "accuracy" style="width: 50px;" value = "<?php echo $m['accuracy'] ?>" readonly
									oninput ="evaluateResult('passed','considered','failed','accountingmarks','excelmarks','englishmarks','aptitudemarks','typingmarks')"
									AUTOFOCUS required> %
								</td>
							</div>
