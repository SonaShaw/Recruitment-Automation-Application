		...
		<div>
			<div class = "panel-heading" style="background-color:white">
				<span style="float:left">
					...
					<div id = "hrname"><font face = "Times New Roman" color = "black"><font face = "Times New Roman" color = "black"><h4><label>Welcome  <?php echo $_SESSION['hod_name']  ?>
					</label></h4></font></div>
					<div id = "hrrole"><font face = "Times New Roman" color = "black"><h4><font face = "Times New Roman" color = "black"><label> Designation:  
					<?php echo $_SESSION['hod_designation']  ?></font></h4></div>
				</span>
				...
				<span style=" float:right">
					...
					<div align = "right"><p id = "currenttime"><font face = "Times New Roman" color = "black" ><h4><?php  echo $time  ?></h4></font></p></div>
					<div align = "right"><p id = "currentdate"><font face = "Times New Roman" color = "black" ><h4><?php  echo $date  ?></h4></font></p></div>
				</span>
			</div>	
		</div>
