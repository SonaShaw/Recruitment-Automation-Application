...
<div class="container" >
	...
	<div class = "col-sm-6">
		<br>
		<div class="panel panel-primary" >
			<div class = "panel-heading" align = "center" style="background-color:#081450;"><font face = "Times New Roman"><h3><b>Start Aptitude Test</b></h3></font>
			</div>
			<div class = "panel-body">
				<p><font face = "times new roman" size = "4"><b>Your English Test is now complete. Next, you have an Aptitude Test.</b></font></p>
				<p align = "center"><font face = "times new roman" size = "4"><b>Click NEXT to continue.</b></font></p>
				<br><br>
			<form action="intermediate_aptitude_quiz.php" method = "post">	
				<div align = "center">
