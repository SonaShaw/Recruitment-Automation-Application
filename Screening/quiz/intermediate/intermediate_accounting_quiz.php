...
<div class="container" >
	...
	<div class = "col-sm-12">
		...
		<form action="intermediate_accounting_answer.php" method="POST" id = "submit-test">
		<div class="panel panel-primary" >
			<!----------------------fetch questions for intermediate level---------------------------------->
			<?php
				$mcq = new user;
				$catagory_id = 1;
				//$level_id = 2;
				//$mcq->set_session_for_catagory_and_level($catagory_id,$level_id);
				$mcq->fetch_intermediate_question_set($catagory_id);
